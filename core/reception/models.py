...
class Command(models.Model):
    ...
    client_cin = models.CharField(verbose_name="Client CIN", max_length=20, unique=True)
    command_token = models.CharField(verbose_name="Command Token", max_length=10, unique=True)
